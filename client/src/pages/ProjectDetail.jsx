                    ...
                    <div className="data-list">
                        {dashboard.pullRequests.length === 0 ? (
                            ...
                            dashboard.pullRequests.map(pr => (
                                <a key={pr.id} href={pr.url} target="_blank" rel="noopener noreferrer" className="list-item pr-item">
                    ...
                    <div className="data-list">
                        {dashboard.commits.length === 0 ? (
                            ...
                            dashboard.commits.map(commit => (
                                <a key={commit.sha} href={commit.url} target="_blank" rel="noopener noreferrer" className="list-item commit-item">
                                    <div className="list-item-left">
                ...
                {activeTab === 'slack' && (
                    <div className="data-list">
                        {dashboard.slackMessages.length === 0 ? (
                            ...
                            dashboard.slackMessages.map(msg => (
                                <div key={msg.ts} className="list-item slack-item">
